      ...
      <Media query="(max-width:800px)">
        ...
        <Navbar light expand="md"  className="headerstyle">
         ...
         {first}
          ...
          <DropdownMenu>
          <DropdownItem tag="a" href="/menu"   >Profile</DropdownItem>
            ...
            <div class="headerprop">
            <Navbar light expand="md"  className="headerstyle">
              <NavbarBrand href="/"><span style={{color:"yellow"}}>i</span>Rooms</NavbarBrand>
              <NavbarToggler onClick={this.toggle} className="toggler" />
              <Collapse isOpen={this.state.isOpen} navbar>
                <Nav className="ml-auto" navbar>
                <NavItem>
                  ...
                  <NavItem>
                    <NavLink href="/aboutus"className="coollink">
                  ...
                  <NavItem>
                  <NavLink href="/menu"className="coollink">
